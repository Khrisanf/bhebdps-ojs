describe("About Objects (about_objects.js)", function () {
  ...
  describe("Properties", function () {
    ...
    it("should confirm that properties are case sensitive", function () {
      ...
      expect(megalomaniac.henchWoman).toBe(undefined); // case-sensitive, henchWoman doesn't exist
    });
  });
  ...
  it("should use prototype to add to all objects", function () {
      ...
      expect(simpleCircle.colour).toBe(undefined); // simpleCircle has no colour property
